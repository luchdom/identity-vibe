...
namespace Orders.Data.Entities.Mappers;

public static class OrderEntityMappers
{
    // Entity → Domain mapping
    public static OrderViewModel ToDomain(this Order entity) => new()
    {
        Id = entity.Id,
    ...
    public static CustomerViewModel ToDomain(this Customer entity) => new()
    {
        Id = entity.Id,
    ...
    public static OrderItemViewModel ToDomain(this OrderItem entity) => new()
    {
        Id = entity.Id,
    ...
    public static OrderStatusHistoryViewModel ToDomain(this OrderStatusHistory entity) => new()
    {
        Id = entity.Id,
    ...
    public static ShippingViewModel? ToDomainShipping(this Order entity)
    {
    ...
    public static Customer ToEntity(this CustomerViewModel domainCustomer) => new()
    {
    ...
    public static OrderItem ToEntity(this OrderItemViewModel domainItem, int orderId)
    {
